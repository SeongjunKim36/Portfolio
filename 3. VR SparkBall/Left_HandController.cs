...
public class Left_HandController : Photon.PunBehaviour
{
    ...
    void Update()
    {
        ...
        if (trigger.GetStateDown(handType))
        {
            ...
            GrabAnimOn();
            //Kuckle_L.GetComponent<BoxCollider>().enabled = false;
            ObjectColliderOn();
        }
        if (trigger.GetStateUp(handType))
        {
            ...
            GrabAnimOff();
            //Kuckle_L.GetComponent<BoxCollider>().enabled = true;
